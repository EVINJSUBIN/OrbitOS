...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Terminal', desc: 'A fake shell (OrbitOSsh) with 20+ commands. Try `help` to see them all.' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'whoami', desc: 'Who is Hack Clubber?' },
      { label: 'about', desc: 'About OrbitOS.' },
      { label: 'skills', desc: 'Technical skills list.' },
      { label: 'projects', desc: 'Projects: RUMI, FRIDAY, Chronovisor, OrbitOS.' },
      ...
      { label: 'weather', desc: 'Fake weather report for OrbitOS City.' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Rainbow Mode', desc: 'Click the "OrbitOS" logo in the top bar 10 times. The top bar turns rainbow for 5 seconds.' },
    ...
    <div style={{ padding: 20, height: '100%', overflow: 'auto' }}>
      <div style={{ marginBottom: 20 }}>
        ...
        <div style={{ fontSize: 12, color: 'var(--color-text-muted)', lineHeight: 1.5 }}>
          Everything you need to know about OrbitOS — features, commands, easter eggs, and more.
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 11, color: 'var(--color-text-muted)', lineHeight: 1.6 }}>
          Made by Hack Clubber and caffeine for the Hack Club Stardance Jam
        </div>
      </div>
    </div>
  )
