...
const BOOT_LINES = [
  { text: 'OrbitOS BIOS v2.1.0', color: '#E8829B' },
  { text: 'Copyright (c) 2026 OrbitOS Systems', color: '#6B5070' },
  { text: '', color: '' },
  ...
  { text: '', color: '' },
  { text: '[  0.000000] OrbitOS kernel 6.9.0-kawaii booting', color: '#93C5FD' },
  ...
  { text: '', color: '' },
  { text: '[  0.051332] Starting OrbitOS-display-manager.service', color: '#C4B5FD' },
  { text: '[  0.057441] Starting OrbitOS-network.service', color: '#C4B5FD' },
  { text: '[  0.062103] Starting OrbitOS-audio.service', color: '#C4B5FD' },
  { text: '[  0.068992] Starting OrbitOS-dock.service', color: '#C4B5FD' },
  { text: '[  0.074210] Starting OrbitOS-panel.service', color: '#C4B5FD' },
  { text: '[  0.080331] Starting OrbitOS-window-manager.service', color: '#C4B5FD' },
        ...
        <div style={{ position: 'relative', zIndex: 2, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 40, height: '100%', padding: 40 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 24 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 6, width: 200 }}>
              {[['OS', 'OrbitOS 1.0.0'], ['KERNEL', '6.9.0-kawaii'], ['THEME', 'gothic-kawaii-dark'], ['WM', 'framer-motion']].map(([k, v]) => (
