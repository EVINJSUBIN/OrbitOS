...
export default function Desktop() {
  ...
  const [wallpaper, setWallpaper] = useState(() => localStorage.getItem('OrbitOS-wallpaper') || 'wall-0')
  const [liveWall, setLiveWall] = useState(() => localStorage.getItem('OrbitOS-live-wall') || 'live-1')
  ...
  useEffect(() => {
    ...
    window.addEventListener('OrbitOS-bg-change', handler)
    return () => window.removeEventListener('OrbitOS-bg-change', handler)
  }, [])
