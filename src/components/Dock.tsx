...
const coreDockItems: DockItem[] = [
  ...
  { id: 'isstracker', label: 'ISS Tracker', color: 'var(--color-mint)', icon: 'isstracker' },
...
const appTitles: Record<string, string> = {
  ...
  browser: 'Browser', files: 'Files', guide: 'Guide', store: 'OrbitOS Store', settings: 'Settings',
...
const appSizes: Record<string, [number, number]> = {
  ...
  browser: [800, 560], files: [640, 480], store: [420, 580], guide: [500, 560], settings: [450, 500],
  isstracker: [350, 300],
...
const ICONS: Record<string, string> = {
  ...
  isstracker: `<svg viewBox="0 0 56 56"><defs><linearGradient id="g-iss" x1="0" y1="0" x2="56" y2="56" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#141E30"/><stop offset="100%" stop-color="#243B55"/></linearGradient></defs><rect width="56" height="56" rx="14" fill="url(#g-iss)"/><circle cx="28" cy="28" r="16" fill="none" stroke="#00fa9a" stroke-width="1.5" stroke-dasharray="4 4" opacity="0.6"/><path d="M22 28l12-12m-2 14l-4 4" stroke="#00d2ff" stroke-width="3" stroke-linecap="round"/><circle cx="28" cy="28" r="4" fill="white"/></svg>`,
...
export default function Dock() {
  ...
  // Removed Mac-style magnification for Windows-style taskbar
  ...
  const handleClick = (item: DockItem, e: React.MouseEvent) => {
    ...
    try { (window as any).__OrbitOSPlayClick?.('open') } catch {}
